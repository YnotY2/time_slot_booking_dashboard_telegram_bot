...
how_is_our_coffee_made_video = os.getenv("how_is_our_coffee_made_video", "./videos/how_is_our_coffee_made.mp4")
who_are_we_video = os.getenv('who_are_we_video', './videos/who_are_we.mp4')